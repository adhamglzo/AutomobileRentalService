...
<input type="checkbox" id="bars">
  <nav class="nav-bar" id="navbar">
    <div class="content">
      ...
      <ul class="navigation">
        ...
        <!--<li class="link"><a href="homePage.html/#about">about us</a></li> -->
  ...
  <section class="car-form-panel">
    ...
    <button id="go-to-payment" onclick="location.href='#'">MAKE A PAYMENT</button> <!-- makePaymentController -->
    <button id="go-to-payment" onclick="location.href='#'">ADD TO BOOKING</button> <!-- listOfBookingRR -->
