...
public class Bridge implements Serializable {
	...
	private int car_id,rr_id,booking_id,no_of_seats,user_id,admin_id;
	private String rr_address,rr_pNum,rr_license,rr_experience,car_type,car_model,car_color,availability,car_plate,car_brand,booking_date,pickup_location,drop_location,admin_address,admin_pNum,admin_title,admin_department,user_name,user_password,user_email,user_role;
