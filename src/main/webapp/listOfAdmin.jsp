...
<div class="admin-panel">
    ...
    <div class="admin-table">
        <table>
			...
			<tr>
				<td><c:out value="${admins.index + 1}"/></td>
        		<td><c:out value="${admin.admin_id}"/></td>    
            	<td><c:out value="${admin.admin_title}"/></td>   
            	<td><c:out value="${admin.admin_department}"/></td>
            	<td><c:out value="${admin.admin_pNum}"/></td>   
            	<td><c:out value="${admin.admin_address}"/></td>   
                <td><a class="edit-btn" href="ViewAdminController?admin_id=<c:out value="${admin.admin_id}"/>">View</a>
                <button class="edit-btn" id="<c:out value="${admin.admin_id}"/>" onclick="confirmation(this.id)">Delete</button>
                <a class="edit-btn" href="UpdateAdminController?admin_id=<c:out value="${admin.admin_id}"/>">Edit</a></td>
            </tr>
            <script>
